              ...
              <div className="job-detail-description border-provider">
                ...
                <p
                  dangerouslySetInnerHTML={{
                    __html: jobDescriptionWithBreaks!,
                  }}
                />
              </div>
              <div className="job-details-points border-provider">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Possimus omnis id aperiam doloribus, laborum nulla nobis
                obcaecati neque fugit dicta est quos minima dignissimos sunt,
                sit vero impedit qui consequuntur. Dolor minima voluptas,
                officia quisquam quia amet similique ratione consequuntur
                repudiandae quam molestiae dicta itaque quasi exercitationem
                explicabo odio incidunt tenetur provident? Nesciunt aperiam modi
                quia dolores libero enim voluptates! Vitae assumenda maxime
                accusamus cum nobis, odio itaque dignissimos totam eos placeat
                vero ratione aliquam minus fugiat veritatis aut dolorem
                exercitationem numquam illo delectus laborum dolore
                perspiciatis? Nemo, ipsum molestiae. Voluptates, natus qui, in
                dolores officiis exercitationem, quibusdam illum beatae tempora
                ut ipsa optio iusto laudantium? Quod debitis molestiae
                asperiores? Tempora perferendis voluptatem voluptates odio
                commodi adipisci hic eveniet consectetur?
              </div>
            </div>
          </>
        )}
